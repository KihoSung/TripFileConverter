...
public class TsEncriptData
{
	 ...
	 * @return
	 */
	public static InputStream decTripData(InputStream inputStream, String sFileName, String strFilePath)
	{
		byte encKey = 0x01;
		long lnSize = 0;
		...
		String strPlanFileName = sFileName.replace("-X-", "-S-");

		FileOutputStream os = null;

		try
		{
			os = new FileOutputStream(new File(strFilePath + "\\Output", strPlanFileName));
	...
	public static InputStream encTripData(InputStream inputStream, String sFileName, String strFilePath)
	{
		byte encKey = 0x01;
		long lnSize = 0;
		...
		String strPlanFileName = sFileName.replace("-S-", "-X-");
		
		encKey = makeEncFileKey(strPlanFileName);
